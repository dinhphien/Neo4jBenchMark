...
class Store:
    ...
    # def add_time_location_event(self, str_event_id, relation, str_obj_rel_id):
    #     line_data = str_event_id + ',' + str_obj_rel_id+  ',' +relation + '\n'
    #     self.writeToFile(self.fileRelationObject, line_data)
...
if __name__ == '__main__':
    ...
    main((1000000, 2000000, "/home/phien/Neo4j_Server/Neo4jQueryTunning/neo4j-enterprise-4.0.4_after_tuning/import/"))